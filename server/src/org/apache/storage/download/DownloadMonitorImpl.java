...
import org.apache.agent.api.storage.DownloadCommand.Proxy;
import org.apache.agent.api.storage.DownloadCommand.ResourceType;
import org.apache.agent.api.storage.DownloadProgressCommand.RequestType;
...
public class DownloadMonitorImpl extends ManagerBase implements  DownloadMonitor {
	...
	public void handleDownloadEvent(HostVO host, VolumeVO volume, Status dnldStatus) {
        ...
        if (dnldStatus == Status.DOWNLOADED) {
            ...
            _resourceLimitMgr.decrementResourceCount(volume.getAccountId(),
                    org.apache.configuration.Resource.ResourceType.volume);
	...
	private void checksumSync(long hostId){
        ...
        sc.setParameters("download_state", org.apache.storage.VMTemplateStorageResourceAssoc.Status.DOWNLOADED);
