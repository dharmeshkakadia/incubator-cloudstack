...
import org.apache.bridge.io.MTOMAwareResultStreamWriter;
...
import org.apache.bridge.service.S3Constants;
import org.apache.bridge.service.S3RestServlet;
...
import org.apache.bridge.service.core.s3.S3CreateBucketConfiguration;
...
import org.apache.bridge.service.core.s3.S3PolicyContext;
...
import org.apache.bridge.service.exception.InvalidRequestContentException;
import org.apache.bridge.service.exception.NetworkIOException;
...
import org.apache.bridge.util.Converter;
...
import org.apache.bridge.util.XmlHelper;
    ...
    public void executePutBucket(HttpServletRequest request, HttpServletResponse response) throws IOException 
    {
        ...
        if(contentLength > 0) 
        {
            ...
            try {
                is = request.getInputStream();
                String xml = StringHelper.stringFromStream(is);
                Class.forName("org.apache.bridge.service.core.s3.S3CreateBucketConfiguration");
