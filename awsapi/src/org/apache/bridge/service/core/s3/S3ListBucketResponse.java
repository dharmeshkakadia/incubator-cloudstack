...
public class S3ListBucketResponse extends S3Response {
	...
	@XElement(name="ContentsList", item="Contents", itemClass="org.apache.gate.service.core.s3.S3ListBucketObjectEntry")
	protected S3ListBucketObjectEntry[] contents;
	
	@XElement(name="CommonPrefixesList", item="CommonPrefixes", itemClass="org.apache.gate.service.core.s3.S3ListBucketPrefixEntry")
