...
// under the License.
package org.apache.agent.resource.consoleproxy;
    ...
    private void launchConsoleProxy(final byte[] ksBits, final String ksPassword, final String encryptorPassword) {
        ...
        if (_consoleProxyMain == null) {
            _consoleProxyMain = new Thread(new Runnable() {
                public void run() {
                    try {
                        Class<?> consoleProxyClazz = Class.forName("org.apache.consoleproxy.ConsoleProxy");
                        try {
            ...
            s_logger.info("org.apache.consoleproxy.ConsoleProxy is already running");
